 ...
 * on 2016-03-18 at 09:24:01 UTC 
 * Modify at your own risk.
 */

package com.example.rajat.prakharbirthdaycard2016.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MyEndpoint {
    ...
    /**
     * Create a request for the method "myEndpoint.sayGreeting".
     *
     * This request holds the parameters needed by the myApi server.  After setting any optional
     * parameters, call the {@link SayGreeting#execute()} method to invoke the remote operation.
     *
     * @param name
     * @param period
     * @return the request
     */
    public SayGreeting sayGreeting(java.lang.String name, java.lang.String period) throws java.io.IOException {
      SayGreeting result = new SayGreeting(name, period);
      initialize(result);
      return result;
    }

    public class SayGreeting extends MyApiRequest<com.example.rajat.prakharbirthdaycard2016.backend.myApi.model.MyBean> {

      private static final String REST_PATH = "sayGreeting/{name}/{period}";

      /**
       * Create a request for the method "myEndpoint.sayGreeting".
       *
       * This request holds the parameters needed by the the myApi server.  After setting any optional
       * parameters, call the {@link SayGreeting#execute()} method to invoke the remote operation. <p>
       * {@link
       * SayGreeting#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       ...
       * @since 1.13
       */
      protected SayGreeting(java.lang.String name, java.lang.String period) {
        super(MyApi.this, "POST", REST_PATH, null, com.example.rajat.prakharbirthdaycard2016.backend.myApi.model.MyBean.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        this.period = com.google.api.client.util.Preconditions.checkNotNull(period, "Required parameter period must be specified.");
      }

      @Override
      public SayGreeting setAlt(java.lang.String alt) {
        return (SayGreeting) super.setAlt(alt);
      }

      @Override
      public SayGreeting setFields(java.lang.String fields) {
        return (SayGreeting) super.setFields(fields);
      }

      @Override
      public SayGreeting setKey(java.lang.String key) {
        return (SayGreeting) super.setKey(key);
      }

      @Override
      public SayGreeting setOauthToken(java.lang.String oauthToken) {
        return (SayGreeting) super.setOauthToken(oauthToken);
      }

      @Override
      public SayGreeting setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SayGreeting) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SayGreeting setQuotaUser(java.lang.String quotaUser) {
        return (SayGreeting) super.setQuotaUser(quotaUser);
      }

      @Override
      public SayGreeting setUserIp(java.lang.String userIp) {
        return (SayGreeting) super.setUserIp(userIp);
      }
      ...
      public SayGreeting setName(java.lang.String name) {
        this.name = name;
        return this;
      }
      ...
      public SayGreeting setPeriod(java.lang.String period) {
        this.period = period;
        return this;
      }

      @Override
      public SayGreeting set(String parameterName, Object value) {
        return (SayGreeting) super.set(parameterName, value);
      }
    }
  ...
  public class SayHi extends MyApiRequest<com.example.rajat.prakharbirthdaycard2016.backend.myApi.model.MyBean> {
